...
('lib/main.jsx!github:floatdrop/plugin-jsx@0.1.1', function(System) {
...
System.register("lib/main.jsx!github:floatdrop/plugin-jsx@0.1.1", ["npm:react@0.12.2"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      ...
      React.render(React.createElement(Hello, {message: "world"}), document.body);
      $__export('default', {});
    }
  };
});
